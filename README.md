...
If you can import the code as a maven project in your IDE and run your unit tests successfully, you do not need to install maven on your local computer. If your IDE is giving you problems here is a link to the maven downloads: https://maven.apache.org/download.cgi, and here are instructions for installation: https://maven.apache.org/install.html.
