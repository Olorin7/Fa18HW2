...
We recommend setting up a more local development environment by installing Java (the docker container runs Java 8) and using an IDE such as Eclipse or IntelliJ (there are plenty of guides outlining how to import maven projects into one of these IDEs). Note that if you have another version of Java installed on your computer it is probably fine to run that as long as you don't use any Java 9/10 features, but be sure to run the maven tests in the docker container frequently to ensure your code will work on our setup. Here is a link to Java 8 downloads: http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html. If you're having trouble installing Java or an IDE, CS61B gives some pretty detailed instructions here: https://sp18.datastructur.es/materials/lab/lab1setup/lab1setup (make sure to use Java 9 rather than Java 8). Here is a guide to install maven locally as well: https://maven.apache.org/install.html.
